...
class unit_tcn(nn.Module):
    def __init__(self, in_channels, out_channels,branch=4,stride=1):
        ...
        branch_3 = nn.Conv2d(b_in, b_out, kernel_size=(3, 1), padding=(1, 0), stride=(stride, 1))

        branch_5 = nn.Conv2d(b_in, b_out, kernel_size=(3, 1), padding=(1, 0), stride=(stride, 1))
        branch_7 = nn.Conv2d(b_in, b_out, kernel_size=(3, 1), padding=(1, 0), stride=(stride, 1))
        branch_9 = nn.Conv2d(b_in, b_out, kernel_size=(3, 1), padding=(1, 0), stride=(stride, 1))
        self.branches = nn.ModuleList([branch_3, branch_5, branch_7, branch_9])
        self.conv = nn.Conv2d(out_channels, out_channels, 1, bias=False)
...
class TCN_GCN_unit(nn.Module):
    def __init__(self, in_channels, out_channels, A, stride=1, residual=True):
        ...
        if not residual:
            ...
            self.residual = nn.Sequential(nn.Conv2d(in_channels, out_channels, 1, stride=(stride, 1),bias=False),
                                          nn.BatchNorm2d(out_channels))
...
class spatial_temporal_transformer(nn.Module):
    def __init__(self,in_channels,coff=4,heads=1):
        ...
        self.spatial_upconv = nn.Conv2d(inter_channels, in_channels, 1)
        ...
        self.temporal_upconv = nn.Conv2d(inter_channels, in_channels, 1)
...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(),
        ...
        self.l6 = spatial_temporal_transformer(128)
        self.l7 = TCN_GCN_unit(128, 128, A)
        self.l8 = TCN_GCN_unit(128, 256, A, stride=2)
        self.l9 = spatial_temporal_transformer(256)
